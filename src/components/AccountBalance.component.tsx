import { fetchAccountBalance, fetchLoginDetails } from "../utilities/accountUtils";
import { useSelector, useDispatch } from 'react-redux';
import type { RootState } from '../store';
import { setAccountBalance, setActivated, setAuthorities, setId, setToken } from "../features/account";
